% File example_combined_session.m
...
datapath = ['..', filesep, 'data', filesep, 'combined_session'];
datafiles = {...
    fullfile(datapath, 'DVH_2012101525.6'),...
    fullfile(datapath, 'DVH_2012101525.8'),...
    fullfile(datapath, 'DVH_2012101526.6'),...
    fullfile(datapath, 'DVH_2012101526.8'),...
    fullfile(datapath, 'DVH_2012101527.6'),...
    fullfile(datapath, 'DVH_2012101527.8'),...
    };
